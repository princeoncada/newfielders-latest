...
// Define the runetime as nodejs for the function and export
export const runtime = 'nodejs';

// Define the POST method for the function to handle the form submission
export async function POST(req: NextRequest) {
  // Get the IP address where the request is coming from
